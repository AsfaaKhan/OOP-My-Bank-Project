...
class Customer {
    ...
    email: string;
    account: Bank;
    constructor(userName: { firstName: string, lastName: string }, age: number, gender: string, mobileNumber: number, CNIC: string, email: string, account: Bank) {
